...
trace1 = go.Scatter(x=x_1,y= y_2,yaxis = 'y2', mode = 'lines+markers',name = 'Total Compensation (in 100 million dollars)')
trace2 = go.Scatter(x=x_1,y= y_3, yaxis = 'y2',mode = 'lines+markers',name = 'Average compensation per employee (in 1000 of dollars)')
...
layout = go.Layout(
    ...
    yaxis2 = dict(title = 'Employee Compensation (in dollars)', overlaying='y',side='right')
)
